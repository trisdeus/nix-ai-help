...
# Script to build the comprehensive example plugin
...
echo -e "${PURPLE}Building comprehensive example plugin...${NC}"
...
go build -buildmode=plugin -o "$PLUGINS_DIR/${PLUGIN_NAME}.so" ./examples/plugins/comprehensive_example.go
